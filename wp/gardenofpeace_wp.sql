...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 13 mars 2022 à 21:26
...
(5, '2022_02_19_192028_create_poi', 1),
(6, '2022_02_19_192132_create_poi_content', 1),
(7, '2022_02_26_150043_addcontent_column', 1),
(8, '2022_02_27_170119_addhas_tour_column', 1),
(9, '2022_02_28_170131_drop_column', 1),
(10, '2022_02_28_170412_create_tours_table', 1),
(11, '2022_03_05_203905_create_poi_tours_table', 1),
(12, '2022_03_06_133732_drop_table', 1),
(13, '2022_03_06_134100_create_poi_tour_table', 1),
(14, '2022_03_13_092636_edit_poi_content', 2),
(15, '2022_03_13_145327_edit_pois', 3),
(16, '2022_03_13_184918_edit_pois', 4),
(17, '2022_03_13_190846_edit_poin_contents', 5);
...
(1, 'App\\Models\\User', 1, 'myapptoken', 'c15ffe4bb62ebc396f0e577b622aaf8378a5678d38fa65a1ac93ebbaa8d0f0d4', '[\"*\"]', '2022-03-13 15:35:06', '2022-03-12 17:39:59', '2022-03-13 15:35:06');
...
INSERT INTO `pois` (`id`, `name`, `lat`, `long`, `hasContent`, `imgpath`, `created_at`, `updated_at`) VALUES
(1, 'poin001', '1.00', '1.00', 1, '', '2022-03-12 17:48:21', '2022-03-12 17:48:21'),
(2, 'poin002', '1.00', '1.00', 1, '', '2022-03-12 17:48:21', '2022-03-12 17:48:21'),
(3, 'poin003', '1.00', '1.00', 1, '', '2022-03-12 17:48:21', '2022-03-12 17:48:21'),
(4, 'poin124', '5.00', '6.00', 0, '', '2022-03-13 14:03:51', '2022-03-13 14:40:31');

-- --------------------------------------------------------

--
-- Structure de la table `poi_contents`
--
...
CREATE TABLE `poi_contents` (
  ...
  `type` enum('poi','plant') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'poi',
...
--
-- Déchargement des données de la table `poi_contents`
--

INSERT INTO `poi_contents` (`id`, `poi_id`, `language`, `type`, `title`, `body`, `filepath`, `created_at`, `updated_at`) VALUES
(1, 1, 'en', 'poi', 'content001', 'body001', 'public/files/SUetwRGStI1IIYVojWAFsePSyvDLrNVISzbkJmVJ.mp3', '2022-03-13 11:36:40', '2022-03-13 11:36:40'),
(2, 1, 'en', 'poi', 'content001', 'body001', '', '2022-03-13 11:40:20', '2022-03-13 11:40:20'),
(3, 1, 'en', 'poi', 'content001', 'body001', '', '2022-03-13 11:40:29', '2022-03-13 11:40:29'),
(4, 1, 'en', 'poi', 'content001', 'body001', 'public/files/81SB3QneS2PNNA6OZEZRK3g3oQ6DLwxnZNXKv9MA.mp3', '2022-03-13 11:40:53', '2022-03-13 11:40:53'),
(5, 1, 'en', 'poi', 'content001', 'body001', '', '2022-03-13 11:41:01', '2022-03-13 11:41:01'),
(6, 4, 'en', 'poi', 'content006', 'body006', '', '2022-03-13 15:16:25', '2022-03-13 15:35:06');

-- --------------------------------------------------------

--
-- Structure de la table `poi_tour`
--

CREATE TABLE `poi_tour` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `poi_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Déchargement des données de la table `poi_tour`
--

INSERT INTO `poi_tour` (`id`, `poi_id`, `tour_id`, `seq`, `created_at`, `updated_at`) VALUES
(16, 1, 25, 6, '2022-03-12 22:54:32', '2022-03-12 22:57:20'),
(18, 3, 25, 10, '2022-03-12 22:54:32', '2022-03-12 22:57:20');
...
(1, 'tour001', 'desc001', '2022-03-12 17:54:51', '2022-03-12 17:54:51'),
(2, 'tour002', 'desc002', '2022-03-12 18:19:55', '2022-03-12 18:19:55'),
(3, 'tour003', 'desc003', '2022-03-12 18:29:30', '2022-03-12 18:29:30'),
(4, 'tour003', 'desc003', '2022-03-12 19:35:25', '2022-03-12 19:35:25'),
(5, 'tour003', 'desc003', '2022-03-12 20:10:28', '2022-03-12 20:10:28'),
(6, 'tour003', 'desc003', '2022-03-12 20:18:06', '2022-03-12 20:18:06'),
(7, 'tour003', 'desc003', '2022-03-12 20:34:24', '2022-03-12 20:34:24'),
(8, 'tour003', 'desc003', '2022-03-12 21:50:35', '2022-03-12 21:50:35'),
(9, 'tour003', 'desc003', '2022-03-12 21:51:58', '2022-03-12 21:51:58'),
(10, 'tour003', 'desc003', '2022-03-12 21:56:17', '2022-03-12 21:56:17'),
(11, 'tour003', 'desc003', '2022-03-12 22:04:18', '2022-03-12 22:04:18'),
(12, 'tour003', 'desc003', '2022-03-12 22:08:13', '2022-03-12 22:08:13'),
(13, 'tour003', 'desc003', '2022-03-12 22:08:58', '2022-03-12 22:08:58'),
(14, 'tour003', 'desc003', '2022-03-12 22:09:34', '2022-03-12 22:09:34'),
(15, 'tour003', 'desc003', '2022-03-12 22:09:52', '2022-03-12 22:09:52'),
(16, 'tour003', 'desc003', '2022-03-12 22:12:19', '2022-03-12 22:12:19'),
(17, 'tour003', 'desc003', '2022-03-12 22:14:17', '2022-03-12 22:14:17'),
(18, 'tour003', 'desc003', '2022-03-12 22:14:48', '2022-03-12 22:14:48'),
(19, 'tour003', 'desc003', '2022-03-12 22:22:47', '2022-03-12 22:22:47'),
(20, 'tour003', 'desc003', '2022-03-12 22:24:36', '2022-03-12 22:24:36'),
(21, 'tour003', 'desc003', '2022-03-12 22:26:02', '2022-03-12 22:26:02'),
(22, 'tour003', 'desc003', '2022-03-12 22:26:20', '2022-03-12 22:26:20'),
(23, 'tour003', 'desc003', '2022-03-12 22:26:37', '2022-03-12 22:26:37'),
(24, 'tour003', 'desc003', '2022-03-12 22:27:18', '2022-03-12 22:27:18'),
(25, 'tour025', 'desc025', '2022-03-12 22:28:18', '2022-03-12 22:44:39');
...
(1, 'admin', 'admin@test.com', NULL, '$2y$10$qr05/aowNTh7axuVtUIncuwhftENFV9atW8.ctp1XZkMzG/qULVGm', NULL, '2022-03-12 17:39:59', '2022-03-12 17:39:59');
...
(1, 1, 'A WordPress Commenter', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2022-03-13 20:25:48', '2022-03-13 20:25:48', 'Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.', 0, '1', '', 'comment', 0, 0);
...
(1, 'siteurl', 'http://localhost/floriadeapp/wp', 'yes'),
(2, 'home', 'http://localhost/floriadeapp/wp', 'yes'),
(3, 'blogname', 'Garden of peace', 'yes'),
(4, 'blogdescription', 'Just another WordPress site', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'admin@aisanet.nl', 'yes'),
...
(91, 'admin_email_lifespan', '1662755148', 'yes'),
...
(105, 'cron', 'a:4:{i:1647206749;a:1:{s:34:\"wp_privacy_delete_old_export_files\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"hourly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:3600;}}}i:1647246349;a:4:{s:18:\"wp_https_detection\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1647289549;a:2:{s:30:\"wp_site_health_scheduled_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"weekly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:604800;}}s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}s:7:\"version\";i:2;}', 'yes'),
...
(120, '_transient_timeout_global_styles_twentytwentytwo', '1647203210', 'no'),
...
(123, '_transient_timeout_global_styles_svg_filters_twentytwentytwo', '1647203210', 'no'),
...
(129, '_site_transient_timeout_theme_roots', '1647204951', 'no'),
...
(1, 1, '2022-03-13 20:25:48', '2022-03-13 20:25:48', '<!-- wp:paragraph -->\n<p>Welcome to WordPress. This is your first post. Edit or delete it, then start writing!</p>\n<!-- /wp:paragraph -->', 'Hello world!', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2022-03-13 20:25:48', '2022-03-13 20:25:48', '', 0, 'http://localhost/floriadeapp/wp/?p=1', 0, 'post', '', 1),
(2, 1, '2022-03-13 20:25:48', '2022-03-13 20:25:48', '<!-- wp:paragraph -->\n<p>This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>...or something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>As a new WordPress user, you should go to <a href=\"http://localhost/floriadeapp/wp/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!</p>\n<!-- /wp:paragraph -->', 'Sample Page', '', 'publish', 'closed', 'open', '', 'sample-page', '', '', '2022-03-13 20:25:48', '2022-03-13 20:25:48', '', 0, 'http://localhost/floriadeapp/wp/?page_id=2', 0, 'page', '', 0),
(3, 1, '2022-03-13 20:25:48', '2022-03-13 20:25:48', '<!-- wp:heading --><h2>Who we are</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>Our website address is: http://localhost/floriadeapp/wp.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Comments</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor&#8217;s IP address and browser user agent string to help spam detection.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>An anonymised string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service Privacy Policy is available here: https://automattic.com/privacy/. After approval of your comment, your profile picture is visible to the public in the context of your comment.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Media</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Cookies</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you leave a comment on our site you may opt in to saving your name, email address and website in cookies. These are for your convenience so that you do not have to fill in your details again when you leave another comment. These cookies will last for one year.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>If you visit our login page, we will set a temporary cookie to determine if your browser accepts cookies. This cookie contains no personal data and is discarded when you close your browser.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>When you log in, we will also set up several cookies to save your login information and your screen display choices. Login cookies last for two days, and screen options cookies last for a year. If you select &quot;Remember Me&quot;, your login will persist for two weeks. If you log out of your account, the login cookies will be removed.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>If you edit or publish an article, an additional cookie will be saved in your browser. This cookie includes no personal data and simply indicates the post ID of the article you just edited. It expires after 1 day.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Embedded content from other websites</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracking your interaction with the embedded content if you have an account and are logged in to that website.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Who we share your data with</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you request a password reset, your IP address will be included in the reset email.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>How long we retain your data</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognise and approve any follow-up comments automatically instead of holding them in a moderation queue.</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>For users that register on our website (if any), we also store the personal information they provide in their user profile. All users can see, edit, or delete their personal information at any time (except they cannot change their username). Website administrators can also see and edit that information.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>What rights you have over your data</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p><!-- /wp:paragraph --><!-- wp:heading --><h2>Where we send your data</h2><!-- /wp:heading --><!-- wp:paragraph --><p><strong class=\"privacy-policy-tutorial\">Suggested text: </strong>Visitor comments may be checked through an automated spam detection service.</p><!-- /wp:paragraph -->', 'Privacy Policy', '', 'draft', 'closed', 'open', '', 'privacy-policy', '', '', '2022-03-13 20:25:48', '2022-03-13 20:25:48', '', 0, 'http://localhost/floriadeapp/wp/?page_id=3', 0, 'page', '', 0);
...
(1, 'admin', '$P$B4iL7SqZH.jgVoFCg5Y0Aw9vQPOiYA1', 'admin', 'admin@aisanet.nl', 'http://localhost/floriadeapp/wp', '2022-03-13 20:25:48', '', 0, 'admin');
...
--
-- Index pour la table `poi_contents`
--
ALTER TABLE `poi_contents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `poi_content_poi_id_foreign` (`poi_id`);

--
-- Index pour la table `poi_tour`
--
ALTER TABLE `poi_tour`
  ADD PRIMARY KEY (`id`),
  ADD KEY `poi_tour_poi_id_foreign` (`poi_id`),
  ADD KEY `poi_tour_tour_id_foreign` (`tour_id`);
...
--
-- AUTO_INCREMENT pour la table `poi_contents`
--
ALTER TABLE `poi_contents`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `poi_tour`
--
ALTER TABLE `poi_tour`
...
--
-- Contraintes pour la table `poi_contents`
--
ALTER TABLE `poi_contents`
  ADD CONSTRAINT `poi_content_poi_id_foreign` FOREIGN KEY (`poi_id`) REFERENCES `pois` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `poi_tour`
--
ALTER TABLE `poi_tour`
  ADD CONSTRAINT `poi_tour_poi_id_foreign` FOREIGN KEY (`poi_id`) REFERENCES `pois` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `poi_tour_tour_id_foreign` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
